...
# --- SURVIVOR: COND_INV_1457_8 (MEDIUM) line 1457 in validate_strict() ---
# Source:  if($rules->{'error_msg'}) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_1457_8 line 1457 in validate_strict()';
    # NOTE: Params::Validate::Strict has no constructor — call class methods directly.
    # e.g. my $result = Params::Validate::Strict->method(...);
    # TODO: exercise line 1457 in validate_strict() to detect the mutant
    fail('COND_INV_1457_8: replace with real assertion');
}
