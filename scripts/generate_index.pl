...
<html>
	<head>
	<title>Params::Validate::Strict Coverage Report</title>
	<style>
...
<body>
<div class="badges">
	<a href="https://github.com/nigelhorne/Params-Validate-Strict">
		<img src="https://img.shields.io/github/stars/nigelhorne/Params-Validate-Strict?style=social" alt="GitHub stars">
	</a>
	<img src="$coverage_badge_url" alt="Coverage badge">
</div>
<h1>Params::Validate::Strict</h1><h2>Coverage Report</h2>
<table>
...
chomp $commit_sha;
my $github_base = "https://github.com/nigelhorne/Params-Validate-Strict/blob/$commit_sha/";
...
my $commit_url = "https://github.com/nigelhorne/Params-Validate-Strict/commit/$commit_sha";
...
foreach my $file (@history_files) {
	...
	my $url = "https://github.com/nigelhorne/Params-Validate-Strict/commit/$sha";
...
push @html, <<"HTML";
<footer>
	<p>Project: <a href="https://github.com/nigelhorne/Params-Validate-Strict">Params-Validate-Strict</a></p>
